...
define(["require", "exports", "parse/parse", "parse/text", "khepri/lex/boolean_lexer", "khepri/lex/null_lexer"], (function(require, exports, parse, __o, __o0, __o1) {
    ...
    var keywordList = ["break", "case", "catch", "continue", "debugger", "default", "delete", "do", "else", "finally", "for", "function", "if", "in", "instanceof", "typeof", "new", "var", "return", "void", "switch", "while", "this", "with", "throw", "try", "export", "package", "class", "enum", "interface", "extends", "implements", "private", "public", "protected", "super", "const", "yield", "import", "let", "static", "_"];
