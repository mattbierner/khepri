...
define(["require", "exports", "parse/parse"], (function(require, exports, parse) {
    ...
    (SourcePosition.prototype.increment = (function(tok) {
        return ((tok === "\n") ? new(SourcePosition)((this.line + 1), 0) : new(SourcePosition)(this.line, (this.column + 1)));
    }));
    ...
    (SourceLocation.merge = (function(s1, s2) {
        return new(SourceLocation)(((s1.start.compare(s2.start) > 0) ? s2.start : s1.start), ((s1.end.compare(s2.end) > 0) ? s1.end : s2.end));
    }));
