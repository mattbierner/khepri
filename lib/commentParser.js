...
/**
 * Parser for string of characters inside of multi line comment.
 */
var multiLineCommentChars = parse.Parser('multiLineCommentChars Parser',
    parse.either(
...
////////////////////////////////////////
/**
 * Parser for any ECMAScript 5.1 comment
 */
var comment = parse.Parser('Comment Parser',
    parse.either(
