...
define(["ecma/ast/node"], function(ast_node) {
    ...
    var addImmutableBinding = function(id, loc) {
        return modify(function(s) {
            return Scope.addMapping(Scope.addMutableBinding(id, loc), id, id);
        }
        );
    }
    ;
    var addUniqueMutableBinding = function(id, loc) {
        return examine(function(s) {
            return (s.hasBinding(id) ? function(new_id) {
                return seq([addMutableBinding(new_id, loc), setScope(Scope.addMapping(s, id, new_id))]);
            }
    ...
    var _check = function(node) {
        ...
        switch(node.type){
            ...
            return seq([(node.id ? examine(function(s) {
                ...
                return addImmutableBindingInRealBlock(x.name);
            }
    ...
    var check = function(root, globals) {
        ...
        var scope = globals.reduce(function(p, c) {
            return Scope.addImmutableBinding(p, c, null);
        }
        , new Scope(({}), null, ({})));
        return _check(root)(scope, function(s) {
            return s;
        }
        , function(err, s) {
            throw err;
