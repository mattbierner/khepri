        ...
        ast_value = ast_value; {
            ...
            var _check = (function(node) {
                ...
                switch (node.type) {
                    ...
                    case "Package":
                        return seq([addImmutableBindingInRealBlock("require", null), addImmutableBindingInRealBlock("exports", null), addImmutableBindingInRealBlock("module", null), _check(node.exports), ((node.body.type === "WithStatement") ? next(seq(node.body.bindings.map(_check)), _check(node.body.body)) : seq(map(node.body.body, _check)))]);
                    case "PackageExports":
