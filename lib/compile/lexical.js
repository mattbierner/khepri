...
define((function(require, exports, module) {
    ...
    (State.setRealScope = (function(s, scope) {
        return new State(scope, s.scope);
    }));
    var ok = (function(x) {
    ...
    var realBlock = (function(body) {
        return examineRealScope((function(s) {
            return seq([setRealScope(new Scope(({}), s, s.mapping)), body, setRealScope(s)]);
        }));
    });
    ...
    var addUniqueMutableBinding = (function(id, loc) {
        return examineRealScope((function(s) {
            return (s.hasBinding(id) ? (function(new_id) {
                return seq([addMutableBinding(new_id, loc), addMapping(id, new_id)]);
    ...
    var addImmutableBindingInRealBlock = (function(id, loc) {
        return seq([checkCanAddOwnBinding(id, loc), examineScope((function(s) {
            return next(setScope(Scope.addMapping(s, id, id)), modifyScope((function(s) {
    ...
    var addImmutableBinding = (function(id, loc) {
        return seq([checkCanAddOwnBinding(id, loc), examineScope((function(s) {
            return (s.hasBinding(id) ? (function(new_id) {
                return next(setScope(Scope.addMapping(s, id, new_id)), modifyScope((function(s) {
    ...
    var _check = (function(node) {
        ...
        switch (node.type) {
            ...
            case "IdentifierPattern":
                return seq([addImmutableBinding(node.name, node.loc), _check(node.init), examineScope((function(s) {
            ...
            case "VariableDeclarator":
                return seq([tryAddMutableBinding(node.id.name, node.loc.start), _check(node.init), examineScope((function(s) {
