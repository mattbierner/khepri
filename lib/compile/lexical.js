...
define((function(require, exports, module) {
    ...
    var _check = (function(node) {
        ...
        switch (node.type) {
            ...
            case "Package":
                return seq([addImmutableBindingInRealBlock("require", null), addImmutableBindingInRealBlock("exports", null), addImmutableBindingInRealBlock("module", null), _check(node.exports), _check(node.body)]);
            case "PackageExports":
