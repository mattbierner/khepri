...
define((function(require, exports, module) {
    ...
    var _check = (function(node) {
        ...
        switch (node.type) {
            ...
            case "Package":
                return seq([addImmutableBindingInRealBlock("require", null), addImmutableBindingInRealBlock("exports", null), addImmutableBindingInRealBlock("module", null), _check(node.exports), ((node.body.type === "WithStatement") ? next(seq(node.body.bindings.map(_check)), _check(node.body.body)) : seq(map(node.body, _check)))]);
            case "PackageExports":
            ...
            case "ObjectPattern":
                return examineScope((function(s) {
                    ...
                    (node.elements = map(node.elements, (function(x) {
                        return (x.value ? x : ({
                            "key": ast_value.Literal.create(null, "string", x.key.id.name),
                            "value": x.key
                        }));
                    })));
