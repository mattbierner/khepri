        ...
        switch (node.type) {
            ...
            case "BinaryExpression":
                switch (node.operator) {
                    case "\\>":
                        return transform(khepri_expression.CallExpression.create(null, khepri_expression.FunctionExpression.create(node.loc, null, khepri_pattern.ArgumentsPattern.create(null, null, [khepri_pattern.IdentifierPattern.create(null, khepri_value.Identifier.create(null, "f")), khepri_pattern.IdentifierPattern.create(null, khepri_value.Identifier.create(null, "g"))]), khepri_statement.BlockStatement.create(null, [khepri_statement.ReturnStatement.create(null, khepri_expression.FunctionExpression.create(node.loc, null, khepri_pattern.ArgumentsPattern.create(null, null, []), khepri_statement.BlockStatement.create(null, [khepri_statement.ReturnStatement.create(null, khepri_expression.CallExpression.create(null, khepri_value.Identifier.create(null, "g"), [khepri_expression.CallExpression.create(null, khepri_expression.MemberExpression.create(null, khepri_value.Identifier.create(null, "f"), khepri_value.Identifier.create(null, "apply")), [khepri_value.Literal.create(null, "null", null), khepri_value.Identifier.create(null, "arguments")])]))])))])), [node.left, node.right]));
                    case "|>":
                        return transform(khepri_expression.CallExpression.create(null, node.right, [node.left]));
                    default:
            ...
            case "LetExpression":
                return transform(khepri_expression.CallExpression.create(node.loc, khepri_expression.FunctionExpression.create(null, null, khepri_pattern.ArgumentsPattern.create(null, null, []), khepri_statement.BlockStatement.create(null, [khepri_statement.WithStatement.create(null, node.bindings, khepri_statement.BlockStatement.create(null, [khepri_statement.ReturnStatement.create(null, node.body)]))])), []));
            case "CurryExpression":
                return ((node.args.length === 0) ? transform(node.base) : transform(khepri_expression.CallExpression.create(null, khepri_expression.MemberExpression.create(null, transform(node.base), khepri_value.Identifier.create(null, "bind")), concat(khepri_value.Literal.create(null, "null", null), map(node.args, transform)))));
            case "UnaryOperatorExpression":
                return transform(khepri_expression.FunctionExpression.create(node.loc, null, khepri_pattern.ArgumentsPattern.create(null, null, [khepri_pattern.IdentifierPattern.create(null, khepri_value.Identifier.create(null, "x"))]), khepri_statement.BlockStatement.create(null, [khepri_statement.ReturnStatement.create(null, khepri_expression.UnaryExpression.create(null, node.op, khepri_value.Identifier.create(null, "x")))])));
            case "BinaryOperatorExpression":
                var kind = (((node.op === "||") || (node.op === "&&")) ? khepri_expression.LogicalExpression : khepri_expression.BinaryExpression);
                return transform(khepri_expression.FunctionExpression.create(node.loc, null, khepri_pattern.ArgumentsPattern.create(null, null, [khepri_pattern.IdentifierPattern.create(null, khepri_value.Identifier.create(null, "x")), khepri_pattern.IdentifierPattern.create(null, khepri_value.Identifier.create(null, "y"))]), khepri_statement.BlockStatement.create(null, [khepri_statement.ReturnStatement.create(null, kind.create(null, node.op, khepri_value.Identifier.create(null, "x"), khepri_value.Identifier.create(null, "y")))])));
            case "BinaryOperatorExpression":
                return transform(khepri_expression.FunctionExpression.create(node.loc, null, khepri_pattern.ArgumentsPattern.create(null, null, [khepri_pattern.IdentifierPattern.create(null, khepri_value.Identifier.create(null, "x")), khepri_pattern.IdentifierPattern.create(null, khepri_value.Identifier.create(null, "y")), khepri_pattern.IdentifierPattern.create(null, khepri_value.Identifier.create(null, "z"))]), khepri_statement.BlockStatement.create(null, [khepri_statement.ReturnStatement.create(null, khepri_expression.ConditionalExpression.create(null, khepri_value.Identifier.create(null, "x"), khepri_value.Identifier.create(null, "y"), khepri_value.Identifier.create(null, "z")))])));
            case "FunctionExpression":
                return (function() {
                    {
                        var params = reduce(transform(node.params.elements), (function(p, c) {
                            if ((!c || (c.type === "EllipsisPattern"))) return p;

                            return p.concat([transform(c)]);
                        }), []),
                            prefix = reduce(node.params.elements, (function(p, c) {
                                var base;
                                switch (c.type) {
                                    case "ArrayPattern":
                                        (base = transform(c.id));
                                ...
                                return p;
                            }), (node.params.id ? [khepri_declaration.VariableDeclaration.create(null, [khepri_declaration.VariableDeclarator.create(null, transform(node.params.id), khepri_value.Identifier.create(null, "arguments"))])] : [])); {
                                return ecma_expression.FunctionExpression.create(node.loc, transform(node.id), params, transform(khepri_statement.BlockStatement.create(node.body.loc, concat(prefix, node.body.body))));
                        }
                    }
                })();
