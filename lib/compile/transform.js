    ...
    var transform = (function(node) {
        ...
        switch (node.type) {
            ...
            case "Package":
                ...
                var fBody = ((node.body.type === "WithStatement") ? transform(khepri_statement.WithStatement.create(null, node.body.bindings.filter((function(x) {
                    return (x.type !== "ImportPattern");
                })), node.body.body)) : transform(node.body));
                var body = ecma_expression.FunctionExpression.create(null, null, concat(ecma_value.Identifier.create(null, "require"), ecma_value.Identifier.create(null, "exports")), ecma_statement.BlockStatement.create(fBody.loc, concat(ecma_statement.ExpressionStatement.create(null, ecma_value.Literal.create(null, "string", "use strict")), exportHeader, fBody.body, exportBody)));
