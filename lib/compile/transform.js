        ...
        switch (node.type) {
            ...
            case "BinaryExpression":
                switch (node.operator) {
                    case "\\>":
                        return transform(khepri_expression.CallExpression.create(null, khepri_expression.FunctionExpression.create(node.loc, null, khepri_pattern.ParameterList.create(null, [khepri_pattern.IdentifierPattern.create(null, khepri_value.Identifier.create(null, "f")), khepri_pattern.IdentifierPattern.create(null, khepri_value.Identifier.create(null, "g"))]), khepri_statement.BlockStatement.create(null, [khepri_statement.ReturnStatement.create(null, khepri_expression.FunctionExpression.create(node.loc, null, khepri_pattern.ParameterList.create(null, [khepri_pattern.IdentifierPattern.create(null, khepri_value.Identifier.create(null, "x"))]), khepri_statement.BlockStatement.create(null, [khepri_statement.ReturnStatement.create(null, khepri_expression.CallExpression.create(null, khepri_value.Identifier.create(null, "g"), [khepri_expression.CallExpression.create(null, khepri_value.Identifier.create(null, "f"), [khepri_value.Identifier.create(null, "x")])]))])))])), [node.left, node.right]));
                    case "|>":
