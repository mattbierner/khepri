 ...
 */
var identifier = parse.Parser('Identifier Parser', parse.bind(identifierName, function(name) {
    if (reservedWordParser.keywordList.indexOf(name) != -1) {
        return parse.never(); 
    } 
    return parse.always(name);
}));
