...
define(['parse/parse', 'parse/parse_string',
        'stream',
        'ecma/lex/reserved_word_lexer', 'ecma/lex/string_lexer'],
...
// Identifier
////////////////////////////////////////
var _reservedWordTest = parse.next(reserved_word_lexer.reservedWord,
    parse.eof());
...
var identifier = parse.Parser('Identifier Lexer',
    parse.bind(identifierName, function(name) {
        return (parse.testStream(_reservedWordTest, name) ?
            parse.never() :
            parse.always(stream.reduce(name, join, '')));
    }));
