 ...
 */
define(['parse/parse', 'ecma/ast/node', 'ecma/lex/boolean_lexer', 'ecma/lex/comment_lexer', 'ecma/lex/identifier_lexer',
...
function(parse, ast, boolean_lexer, comment_lexer, identifier_lexer,
 ...
 */
var langLexer = parse.many(parse.RecParser(function(self) {
    return parse.choice(
 ...
 */
var lex = parse.run.bind(undefined, lexer);

/**
 * Lexes ECMAScript 5.1 input and outputs only language element tokens
 */
var lexLang = parse.run.bind(undefined, langLexer);
