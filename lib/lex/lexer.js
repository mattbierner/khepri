...
define(["require", "exports", "parse/parse", "nu/stream", "khepri_ast/token", "khepri/position", "khepri/lex/boolean_lexer", "khepri/lex/comment_lexer", "khepri/lex/identifier_lexer", "khepri/lex/line_terminator_lexer", "khepri/lex/null_lexer", "khepri/lex/number_lexer", "khepri/lex/punctuator_lexer", "khepri/lex/reserved_word_lexer", "khepri/lex/string_lexer", "khepri/lex/whitespace_lexer", "khepri/lex/regular_expression_lexer"], (function(require, exports, parse, __o, lexToken, __o0, __o1, __o2, __o3, __o4, __o5, __o6, __o7, __o8, __o9, __o10, __o11) {
    ...
    var makeToken = (function(type, p) {
        return binds(enumeration(getPosition, p, getPosition), (function(start, value, end) {
            return always(new(type)(new(SourceLocation)(start, end), value));
        }));
    });
    (literal = choice(expected.bind(null, "string literal")(makeToken(lexToken.StringToken, stringLiteral)), expected.bind(null, "regular expression literal")(makeToken(lexToken.RegularExpressionToken, regularExpressionLiteral)), expected.bind(null, "boolean literal")(makeToken(lexToken.BooleanToken, booleanLiteral)), expected.bind(null, "null literal")(makeToken(lexToken.NullToken, nullLiteral)), expected.bind(null, "number literal")(makeToken(lexToken.NumberToken, numericLiteral))));
    (token = choice(expected.bind(null, "identifier")(attempt(makeToken(lexToken.IdentifierToken, identifier))), attempt(literal), expected.bind(null, "reserved word")(attempt(makeToken(lexToken.KeywordToken, reservedWord))), expected.bind(null, "puctuator")(makeToken(lexToken.PunctuatorToken, punctuator))));
    (inputElementRegExp = choice(expected.bind(null, "comment")(makeToken(lexToken.CommentToken, comment)), expected.bind(null, "whitespace")(makeToken(lexToken.WhitespaceToken, whitespace)), expected.bind(null, "line terminator")(makeToken(lexToken.LineTerminatorToken, lineTerminator)), token));
