...
define(["require", "exports", "parse/parse", "parse/lang", "parse/text", "nu/stream"], (function(require, exports, __o, __o0, __o1, __o2) {
    ...
    var __o = __o,
        ...
        foldl = __o2["foldl"]; {
            ...
            (decimalIntegerLiteral = Parser("Decimal Integer Literal", bind(decimalDigits, (function(num) {
                return always(parseInt(num));
            }))));
            (decimalLiteral = Parser("Decimal Literal Lexer", binds(enumeration(choice(next(decimal, bind(decimalDigits, (function(fractional) {
                return always(parseFloat(("." + fractional)));
            }))), attempt(binds(enumeration(then(decimalDigits, decimal), optional(0, decimalDigits)), (function(whole, fractional) {
                return always(parseFloat(((whole + ".") + fractional)));
            }))), decimalIntegerLiteral), optional(0, exponentPart)), (function(num, exp) {
                return always((num * Math.pow(10, parseInt(exp))));
            }))));
            (numericLiteral = Parser("Numeric Literal Lexer", either(attempt(hexIntegerLiteral), decimalLiteral)));
    }
