...
define(["require", "exports", "parse/parse", "parse/text"], (function(require, exports, __o, __o0) {
    "use strict";
    var openBrace, closeBrace, openParenthesis, closeParenthesis, openBracket, closeBracket, period, semicolon, comma, colon, questionMark, logicalAnd, logicalOr, leftShift, signedRightShift, unsignedRightShift, lessThanOrEqualTo, lessThan, greaterThanOrEqualTo, greaterThan, strictEquals, strictDoesNotEqual, equals, doesNotEqual, and, or, xor, assign, leftShiftAssignment, signedRightShiftAssignment, unsignedRightShiftAssignment, additionAssignment, subtrationAssignment, multiplicationAssignment, divisionAssignment, modAssignment, logicalNot, bitwiseNot, addition, subtration, multiplication, mod, division, lambda, punctuator;
    var __o = __o,
        Parser = __o["Parser"],
        __o0 = __o0,
    ...
    (exports.leftShiftAssignment = leftShiftAssignment);
    (exports.signedRightShiftAssignment = signedRightShiftAssignment);
    (exports.unsignedRightShiftAssignment = unsignedRightShiftAssignment);
    (exports.additionAssignment = additionAssignment);
    (exports.subtrationAssignment = subtrationAssignment);
    (exports.multiplicationAssignment = multiplicationAssignment);
    (exports.divisionAssignment = divisionAssignment);
    (exports.modAssignment = modAssignment);
