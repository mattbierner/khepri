 ...
 */
define(['parse', 'identifierLexer', 'lineTerminatorLexer'],
function(parse, identifierLexer, lineTerminatorLexer){
"use strict";
...
var regularExpressionNonTerminator = parse.token(function(tok) {
    return !parse.test(lineTerminatorLexer.lineTerminator, tok);
});
 ...
 */
var regularExpressionFlags = parse.many(identifierLexer.identifierPart);
