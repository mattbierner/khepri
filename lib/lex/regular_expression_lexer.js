 ...
 */
define(['parse/parse', 'parse/parse_eager', 'ecma/lex/identifier_lexer', 'ecma/lex/line_terminator_lexer'],
function(parse, parse_eager, identifier_lexer, line_terminator_lexer){
"use strict";
...
var regularExpressionClassChars = parse_eager.many(regularExpressionClassChar);
 ...
 */
var regularExpressionChars = parse_eager.many(regularExpressionChar);
 ...
 */
var regularExpressionFlags = parse_eager.many(identifier_lexer.identifierPart);
