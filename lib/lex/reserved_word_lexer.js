 ...
 * DO NOT EDIT
*/
define(["require", "exports", "parse/parse", "parse/text", "khepri/lex/boolean_lexer", "khepri/lex/null_lexer"], (function(require, exports, parse, __o, __o0, __o1) {
    "use strict";
    var reservedWord, futureReservedWord, breakKeyword, caseKeyword, catchKeyword, continueKeyword, debuggerKeyword, defaultKeyword, deleteKeyword, doKeyword, elseKeyword, finallyKeyword, forKeyword, functionKeyword, ifKeyword, inKeyword, instanceofKeyword, typeofKeyword, newKeyword, Keyword, returnKeyword, voidKeyword, switchKeyword, whileKeyword, thisKeyword, withKeyword, throwKeyword, tryKeyword, keyword, getKeyword, setKeyword, classKeyword, enumKeyword, extendsKeyword, superKeyword, constKeyword, exportKeyword, importKeyword, implementsKeyword, letKeyword, privateKeyword, publicKeyword, interfaceKeyword, packageKeyword, protectedKeyword, staticKeyword, yieldKeyword;
    var parse = parse,
        ...
        nullLiteral = __o1["nullLiteral"]; {
            var keywordList = ["break", "case", "catch", "continue", "debugger", "default", "delete", "do", "else", "finally", "for", "function", "if", "in", "instanceof", "typeof", "new", "var", "return", "void", "switch", "while", "this", "with", "throw", "try", "class", "enum", "extends", "super", "const", "export", "import", "implements", "let", "private", "public", "interface", "package", "protected", "static", "yield", "get", "set"];
            ...
            (keyword = choice(attempt(breakKeyword), attempt(caseKeyword), attempt(catchKeyword), attempt(continueKeyword), attempt(debuggerKeyword), attempt(defaultKeyword), attempt(deleteKeyword), attempt(doKeyword), attempt(elseKeyword), attempt(finallyKeyword), attempt(forKeyword), attempt(functionKeyword), attempt(ifKeyword), attempt(inKeyword), attempt(instanceofKeyword), attempt(typeofKeyword), attempt(newKeyword), attempt(Keyword), attempt(returnKeyword), attempt(voidKeyword), attempt(switchKeyword), attempt(whileKeyword), attempt(thisKeyword), attempt(withKeyword), attempt(throwKeyword), attempt(tryKeyword), attempt(getKeyword), setKeyword));
            ...
            (futureReservedWord = choice(attempt(classKeyword), attempt(enumKeyword), attempt(extendsKeyword), attempt(superKeyword), attempt(constKeyword), attempt(exportKeyword), attempt(importKeyword), attempt(implementsKeyword), attempt(letKeyword), attempt(privateKeyword), attempt(publicKeyword), attempt(interfaceKeyword), attempt(packageKeyword), attempt(protectedKeyword), attempt(staticKeyword), yieldKeyword));
