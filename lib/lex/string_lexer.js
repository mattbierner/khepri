 ...
 */
define(['parse/parse', 'parse/parse_eager', 'stream', 'ecma/lex/line_terminator_lexer', 'ecma/lex/number_lexer'],
function(parse, parse_eager, stream, line_terminator_lexer, number_lexer){
"use strict";
...
var doubleStringLiteral = parse.between(doubleQuote, doubleQuote,
    parse.bind(doubleStringCharacters, function(str) {
        return parse.always(stream.toArray(str).join(''));
    })
);
