 ...
 */
define(['parse/parse', 'parse/parse_eager', 'ecma/lex/line_terminator_lexer', 'ecma/lex/number_lexer'],
function(parse, parse_eager, line_terminator_lexer, number_lexer){
"use strict";
...
var hexEscapeSequence = parse.next(parse.character('x'),
    parse.bind(parse_eager.times(2, number_lexer.hexDigit),
        fromCharCodeParser));
...
var unicodeEscapeSequence = parse.next(parse.character('u'),
    parse.bind(parse_eager.times(4, number_lexer.hexDigit),
        fromCharCodeParser));
 ...
 */
var doubleStringCharacters = parse_eager.many(doubleStringCharacter);
 ...
 */
var singleStringCharacters = parse_eager.many(singleStringCharacter);
