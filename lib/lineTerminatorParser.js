 ...
 * Line Feed
 */
var lfParser = parse.char(lf);

/**
 * Carriage Return
 */
var crParser = parse.char(cr);

/**
 * Line Separator
 */
var lsParser = parse.char(ls);

/**
 * Paragraph Separator
 */
var psParser = parse.char(ps);
 ...
 * 
 * crParserlfParser sequences are returned as a single token.
 */
