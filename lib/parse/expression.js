...
var binaryExpression = function(node, sep, p) {
    ...
    return parse.Parser('the M', parse.bind(
        parse.consParser(
            p,
...
var memberExpression = (function(){
    ...
    return parse.RecParser(function(self) {
        return parse.either(
            parse.attempt(
                parse.binda(
                    parse.sequence(
...
var newExpression = parse.RecParser(function(self) {
    return parse.either(
        parse.attempt(memberExpression),
        parse.next(parse.many1(token.keyword('new')),
...
var multiplicativeExpression = binaryExpression(astExpression.BinaryExpression, multiplicativeOperator,
    unaryExpression);
...
var additiveExpression = binaryExpression(astExpression.BinaryExpression, additiveOperator,
