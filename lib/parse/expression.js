...
var precedence = function(p, table) {
    ...
    return parse.bind(parse.RecParser(function(self) {
...
var memberExpression = (function(){
    ...
    return parse.NamedRecParser('Member Expression', function(self) {
        return parse.either(
            parse.attempt(
                parse.binda(
                    parse.sequence(
...
var _memoMember = parse.memo(memberExpression);
...
var _memoLeftHandSideExpression = parse.memo(leftHandSideExpression);
...
var binExpression = precedence(unaryExpression, precedenceTable);
