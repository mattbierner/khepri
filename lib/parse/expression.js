...
// Literal
////////////////////////////////////////
var nullLiteral = parse.bind(token.nullLiteral, function(x) {
    return parse.always(new astValue.Literal(x.value, 'null'));
});

var booleanLiteral = parse.bind(token.booleanLiteral, function(x) {
    return parse.always(new astValue.Literal(x.value, 'boolean'));
});

var numericLiteral = parse.bind(token.numericLiteral, function(x) {
    return parse.always(new astValue.Literal(x.value, 'number'));
});

var stringLiteral = parse.bind(token.stringLiteral, function(x) {
    return parse.always(new astValue.Literal(x.value, 'string'));
});

var regularExpressionLiteral = parse.bind(token.regularExpressionLiteral, function(x) {
    return parse.always(new astValue.Literal(x.value, 'RegExp'));
});
