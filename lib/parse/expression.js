 ...
 */
define(['require', 'ecma/parse/program', 'parse/parse', 'parse/parse_eager', 'ecma/lang/ast', 'ecma/parse/token'],
function(require, program, parse, parse_eager, ast, token){
//"use strict";
        ...
        parse.attempt(parse.next(token.keyword('new'),
            parse.binda(
                ...
                function(expression, a) {
                    return parse.always(new MemberConstructorExpressionNode(expression, a));
                }))),
        parse.binda(
            parse.sequence(
                parse.either(
...
var callExpression = parse.binda(
    ...
    function(member, a, accessors) {
        ...
        }, new CallExpressionNode(member, a)));
    });
...
var postfixExpression = parse.binda(
    ...
    function(expression, operator) {
        return (operator !== undefined ?
            parse.always(new PostfixExpressionNode(operator, expression)) :
