    ...
    (conditionalExpression = (function() {
        {
            ...
            return either(nodea(enumeration(attempt(then(binExpr, punctuator("?"))), then(binaryExpression, punctuator(":")), binaryExpression), ast_expression.ConditionalExpression.create), binExpr);
        }
    })());
