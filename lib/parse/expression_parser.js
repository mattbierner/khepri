 ...
 * DO NOT EDIT
*/
define(["require", "exports", "parse/parse", "parse/lang", "nu/stream", "ecma/position", "ecma/parse/common", "ecma/parse/token_parser", "khepri_ast/declaration", "khepri_ast/expression", "khepri_ast/statement", "khepri_ast/pattern", "khepri/parse/program_parser", "khepri/parse/value_parser", "khepri/parse/pattern_parser"], (function(require, exports, __o, __o0, __o1, __o2, __o3, __o4, ast_declaration, ast_expression, ast_statement, ast_pattern, _, __o5, pattern) {
    "use strict";
    ...
    var __o = __o,
        ...
        pattern = pattern; {
            ...
            var parameter = expected("Any pattern", pattern.pattern);
            ...
            var lambdaBody = either(between(punctuator("{"), punctuator("}"), functionBody), node(expression, (function(loc, x) {
                return ast_statement.BlockStatement.create(loc, [ast_statement.ReturnStatement.create(loc, x)]);
            })));
            var lambdaFunctionExpression = nodea(next(punctuator("\\"), enumeration(lambdaFormalParameterList, punctuator("->"), lambdaBody)), (function(loc, parameters, _, body) {
            ...
            var letBinding = Parser("Let Binding", nodea(enumeration(then(letIdentifier, punctuator("=")), conditionalExpression), ast_declaration.Binding.create));
            var letExpression0 = Parser("Let Expression", nodea(next(keyword("let"), enumeration(eager(sepBy1(punctuator(","), letBinding)), next(keyword("in"), conditionalExpression))), ast_expression.LetExpression.create));
            ...
            (unaryOperator = Parser("Unary Operator", choice(keyword("delete"), keyword("void"), keyword("typeof"), punctuator("+"), punctuator("-"), punctuator("~"), punctuator("!"))));
            ...
            var multiplicativeOperator = choice(punctuator("*"), punctuator("/"), punctuator("%"));
            var additiveOperator = either(punctuator("+"), punctuator("-"));
            var shiftOperator = choice(punctuator("<<"), punctuator(">>"), punctuator(">>>"));
            var relationalOperator = choice(punctuator("<"), punctuator(">"), punctuator("<="), punctuator(">="), keyword("instanceof"));
            var equalityOperator = choice(punctuator("=="), punctuator("!="), punctuator("==="), punctuator("!=="));
            ...
            (assignmentOperator = Parser("Assignment Operator", choice(punctuator("="), punctuator("*="), punctuator("*="), punctuator("/="), punctuator("%="), punctuator("+="), punctuator("-="), punctuator("<<="), punctuator(">>="), punctuator(">>>="), punctuator("&="), punctuator("^="), punctuator("|="))));
