...
define(['require',
        ...
        'khepri/parse/program_parser', 'khepri/parse/token_parser', 'khepri/parse/value_parser',
        'khepri/ast/node', 'khepri/ast/expression', 'khepri/ast/value'],
function(require,
        parse, parse_eager,
        stream,
        ecma_parse,
...
var primaryExpression = parse.Parser('Primary Expression',
    parse.choice(
        ...
        parse.attempt(value.identifier),
        value.literal,
        arrayLiteral,
