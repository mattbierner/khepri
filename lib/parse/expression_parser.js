 ...
 * DO NOT EDIT
*/
define(["require", "parse/parse", "parse/parse_eager", "stream/stream", "khepri/parse/_common", "khepri/parse/program_parser", "khepri/parse/value_parser", "ecma/parse/token_parser", "ecma/ast/node", "ecma/ast/expression", "ecma/ast/value"], function(require, parse, parse_eager, stream, ecma_parse, program, value, token, astNode, astExpression, astValue) {
    "use strict";
    ...
    var callExpression = function() {
        var reducer = function(p, c) {
            return ((Array.isArray(c) && c[0].hasOwnProperty("property")) ? c.reduce(accessorReducer, p) : new astExpression.CallExpression(p, c));
        };
