    ...
    var __o = __o,
        ...
        statement = statement; {
            var withStatement = (function() {
                var args = arguments;
                return require("khepri/parse/statement_parser").withStatement.apply(undefined, args);
            });
            var blockStatement = (function() {
                var args = arguments;
                return require("khepri/parse/statement_parser").blockStatement.apply(undefined, args);
            });
