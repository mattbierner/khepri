...
define(["require", "parse/parse", "parse/lang", "ecma/parse/common", "ecma/parse/token_parser", "khepri_ast/package", "khepri/parse/value_parser", "khepri/parse/pattern_parser"], function(require, parse, parse_lang, ecma_parse, token, ast_package, value, pattern) {
    ...
    var packageImport = parse.Parser("Package Import", parse.next(token.keyword("import"), ecma_parse.nodea(parse.enumeration(value.stringLiteral, parse.either(parse.attempt(pattern.objectPattern), pattern.identifier)), ast_package.PackageImport.create)));
