 ...
 * DO NOT EDIT
*/
define(["require", "exports", "parse/parse", "nu/stream", "ecma/position", "ecma/parse/parser", "khepri/parse/program_parser"], (function(require, exports, parse, __o, position, parser, __o0) {
    "use strict";
    ...
    var parse = parse,
        ...
        program = __o0["program"]; {
            ...
            Object.defineProperty(ParserState.prototype, "loc", ({
                "get": (function() {
                    return (isEmpty(this.input) ? new position.SourceLocation(this._prevEnd, this._prevEnd) : first(this.input).loc);
                })
            }));
            (parseStream = (function(s) {
                return parse.runState(program, new ParserState(parserStream(s), new parser.ParserPosition(parse.Position.initial, position.SourcePosition.initial), position.SourcePosition.initial));
            }));
