 ...
 */
define(['require', 'parse/parse', 'parse/parse_eager', 'stream', 'ecma/parse/statement', 'ecma/ast/node', 'ecma/parse/token'],
function(require, parse, parse_eager, stream, statement, ast, token){
//"use strict";
...
var formalParameterList = parse_eager.sepBy(token.punctuator(','), token.identifier);
...
var functionExpression = parse.binda(
    ...
    function(_, id, parameters, body) {
        return parse.always(new FunctionExpressionNode(id, parameters, body));
    });
