 ...
 * DO NOT EDIT
*/
define(["require", "parse/parse", "parse/parse_eager", "nu/stream", "khepri/parse/_common", "khepri/parse/expression_parser", "khepri/parse/statement_parser", "khepri/parse/value_parser", "ecma/parse/token_parser", "ecma/ast/declaration", "ecma/ast/expression", "ecma/ast/program", "ecma/ast/statement"], function(require, parse, parse_eager, stream, ecma_parse, expression, statement, value, token, astDeclaration, astExpression, astProgram, astStatement) {
    "use strict";
    ...
    var program = parse.Parser("Program", ecma_parse.astNode(parse.bind(parse.rec(function(self) {
        return parse.either(parse.next(parse.eof(), parse.always(stream.end)), parse.consParser(sourceElement, self));
    }), function(elements) {
