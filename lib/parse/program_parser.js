...
*/
;
define(["require", "parse/parse", "nu/stream", "ecma/parse/common", "ecma/parse/token_parser", "khepri_ast/program", "khepri/parse/statement_parser"], function(require, parse, stream, ecma_parse, token, ast_program, statement, package_parser) {
    "use strict";
