...
function(parse, parse_eager, astDeclaration, astStatement, token, expression){
//"use strict";

/* Forward declarations
 ******************************************************************************/
var statement = function(){ return astStatement.apply(undefined, arguments); };
...
var variableStatement = parse.bind(
    ...
    function(declarations) {
        return parse.always(new astDeclaration.VariableDeclaration(list, 'var'));
    });
...
var switchStatement = parse.bind(parse.next(token.keyword('switch'), 
    parse.sequence(
         ...
         caseBlock)),
    function(v) {
        return parse.always(new astStatement.SwitchStatement(v[0], v[1].caseBlocks, v[1].defaultBlock));
    });
