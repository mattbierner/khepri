...
statement = parse.Parser('Statement',
    parse.choice(
        ...
        parse.attempt(variableStatement),
        parse.attempt(emptyStatement),
        parse.attempt(ifStatement),
        parse.attempt(iterationStatement),
        parse.attempt(continueStatement),
        parse.attempt(breakStatement),
        parse.attempt(returnStatement),
        parse.attempt(withStatement),
        parse.attempt(switchStatement),
        parse.attempt(throwStatement),
        parse.attempt(tryStatement),
        parse.attempt(debuggerStatement),
        expressionStatement));
