...
define((function(require, exports, module) {
    ...
    var __a4 = require("khepri_ast/statement"),
        ...
        WithStatement = __a4["WithStatement"],
    ...
    var __a6 = require("khepri/parse/pattern_parser"),
        importPattern = __a6["importPattern"],
        pattern = __a6["pattern"];
    var __a7 = require("khepri/parse/value_parser"),
        identifier = __a7["identifier"];
    (statement = (function() {
    ...
    var withBinding = parse.Parser("With Binding", either(importPattern, nodea(enumeration(then(withIdentifier, punctuator("=")), expression), Binding.create)));
    (withStatement = Parser("With Statement", nodea(next(keyword("with"), enumeration(eager(sepBy1(punctuator(","), withBinding)), next(keyword("in"), blockStatement))), WithStatement.create)));
