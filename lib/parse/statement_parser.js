 ...
 * DO NOT EDIT
*/
define(["parse/parse", "parse/parse_lang", "ecma/parse/statement_parser", "ecma/parse/token_parser", "ecma/parse/common", "khepri/parse/expression_parser", "khepri/parse/value_parser", "ecma/ast/clause", "ecma/ast/declaration", "ecma/ast/statement"], function(parse, parse_lang, ecma_statement, token, ecma_parse, expression, value, astClause, astDeclaration, astStatement) {
    "use strict";
    ...
    var doWhileStatement = parse.Parser("Do While Statement", ecma_parse.nodea(parse.next(token.keyword("do"), parse.sequence(statement, token.keyword("while"), parse_lang.between(token.punctuator("("), token.punctuator(")"), expression.expression), token.punctuator(";"))), function(loc, body, _0, test, _1) {
