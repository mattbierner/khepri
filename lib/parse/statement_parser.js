...
define(['parse/parse', 'parse/parse_eager',
        ...
        'khepri/parse/token_parser', 'khepri/parse/_common',
 ...
 * 
 */
var ifStatement = ecma_statement.ifStatement;
...
var continueStatement = parse.Parser('Continue Statement',
    ecma_parse.astNode(parse.bind(
        parse.sequence(token.keyword('continue'), logicalSemiColon),
        function() {
...
var breakStatement = parse.Parser('Break Statement',
    ecma_parse.astNode(parse.bind(
        parse.sequence(token.keyword('break'), logicalSemiColon),
        function() {
